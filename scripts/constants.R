...
if(!evcCrosswalkPath %>% file.exists)
  stop("Could not find the file `EVC Crosswalk.csv`. This file is used to convert continuous EVC codes to categorical codes. This file should be provided by the GitHub repo, please check that the project repository is up to date.")
if(!evhCrosswalkPath %>% file.exists)
  stop("Could not find the file `EVH Crosswalk.csv`. This file is used to convert continuous EVH codes to categorical codes. This file should be provided by the GitHub repo, please check that the project repository is up to date.")
